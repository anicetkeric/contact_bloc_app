...
import 'package:contact_bloc_app/core/utils//utils.dart';
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: GroupedListView<dynamic, String>(
            ...
            groupBy: (element) =>
                _groupingListTitle(element.dateStart).toUpperCase(),
                ...
                children: <Widget>[
                  ListTile(
                    leading: CircleAvatar(
                      ...
                      child: element.phoneNumber != null
                          ? Icon(
                    ...
                    title: Row(
                      children: <Widget>[
                        Text(
                          ...
                          style: TextStyle(
                              color: element.type == CallType.MISSED
                                  ? Colors.red
                                  : Colors.black,
                              fontSize: 14.0),
                        ),
                    ...
                    subtitle: Wrap(
                      ...
                      children: <Widget>[
                        Icon(
                          element.type == CallType.OUTBOUND
                              ? Icons.north_east
                              : element.type == CallType.INBOUND
                                  ? Icons.south_west
                                  : Icons.south_east,
                          size: 10.0,
                          color: element.type == CallType.OUTBOUND
                              ? Colors.green
                              : element.type == CallType.INBOUND
                                  ? Colors.blue
                                  : Colors.red,
                    ...
                    trailing: Wrap(
                      ...
                      children: <Widget>[
                        Text(Utility.getPassedTime(element.dateStart.toString()),
                            style: TextStyle(
                                fontWeight: FontWeight.normal,
                                fontSize: 11.0,
                                color: Colors.grey)),
